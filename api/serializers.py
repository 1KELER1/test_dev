...
#project serializers
from .models import Team, Project, Task, Note, Objectives, Notification
...
class NotificationSerializer(serializers.ModelSerializer):
    team = serializers.SlugRelatedField(slug_field='name', queryset=Team.objects.all(), required=False)
    
    class Meta:
        model = Notification
        fields = ['id', 'message', 'user', 'type', 'team', 'created_at', 'is_read']
